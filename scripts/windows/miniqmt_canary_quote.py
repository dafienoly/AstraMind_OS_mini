...
def run(instrument: str, xtquant_path: str | None, quote_port: int | None) -> dict[str, object]:
    if xtquant_path:
    ...
    return {
        "gateway_version": "wp-0021-canary-quote-v2",
...
def main() -> int:
    ...
    try:
        result = run(args.instrument, args.xtquant_path, args.quote_port)
