...
- [WP-0073A：核心 H20/H60 B0/Ridge、滚动预测与绝对收益校准](./planning/work-packages/WP-0073A-core-h20-h60-ridge-calibration.md)
- [WP-0073B：核心 H20/H60 LightGBM 有预算挑战](./planning/work-packages/WP-0073B-core-lightgbm-challenge.md)
- [WP-0074A：核心 Ridge O0 回放、C2 证据与 LightGBM 槽位](./planning/work-packages/WP-0074A-core-ridge-o0-evidence-slots.md)
- [WP-0074B：核心最终 O0、晋级证据与 CorePolicy](./planning/work-packages/WP-0074B-core-final-policy-evidence.md)
