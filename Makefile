.PHONY: bootstrap doctor dev check docs-check e2e-smoke provider-probe miniqmt-l1-capture tactical-research-smoke shadow-smoke data-snapshot data-backfill data-backfill-h2 data-backfill-h3 data-backfill-h4 contracts-generate contracts-check
